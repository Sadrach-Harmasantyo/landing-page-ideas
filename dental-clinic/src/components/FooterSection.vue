    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        <div>
          <div class="flex items-center space-x-2 mb-6">
            ...
            <span class="font-heading font-bold text-2xl">DentalCare</span>
          </div>
          <p class="text-neutral-400 mb-6">
            Providing exceptional dental care with a gentle touch. Your smile is
            our priority.
          </p>
        ...
        <div>
          ...
          <div v-if="isSubscribed" class="bg-neutral-700 rounded-lg p-4">
          ...
          <form v-else @submit.prevent="subscribe" class="flex">
            <input
              type="email"
              v-model="subscribeEmail"
              placeholder="Your email address"
              required
              class="flex-grow px-4 py-2 bg-neutral-700 rounded-l-lg border-0 focus:ring-2 focus:ring-primary-500 focus:outline-none text-white"
            />
            <button
              type="submit"
      ...
      <div class="border-t border-neutral-700 pt-8 mt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-neutral-400 text-center md:text-left mb-4 md:mb-0">
